...
import { Mail, Phone, Globe, Send, CheckCircle2, User, FileText, Sparkles, MapPin, Upload, Trash2, Paperclip, Image, AlertCircle, Compass, Instagram, Facebook } from "lucide-react";
          ...
          <div className="lg:col-span-5 bg-[#FAF9F6] rounded-xl p-8 border border-[#1A1D1C] shadow-sm flex flex-col justify-between h-full min-h-[480px]">
            <div>
              ...
              <p className="font-hand text-lg text-[#5E605E] leading-relaxed mb-8">
                We read every reflection deeply. If you feel called to transition from standard instruction structures into Right Education environments, connect with Srini directly or write your thoughts.
              </p>
              ...
              <div className="space-y-6">
                ...
                {/* Channel 5: WhatsApp Chatbot */}
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded bg-[#25D366]/10 flex items-center justify-center text-[#25D366] shrink-0 border border-[#25D366]/30">
                  ...
                  <div>
                    <span className="font-amatic text-base text-[#25D366] font-bold tracking-wider uppercase block">
                      WHATSAPP CHATBOT
                    </span>
                    <p className="font-hand text-xl text-espresso uppercase">
                      <a 
                        href="https://wa.me/917022973023" 
                        target="_blank" 
                        rel="noopener noreferrer" 
                ...
                {/* Channel 6: Social Ecosystem */}
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded bg-amber-50 flex items-center justify-center text-[#F37021] shrink-0 border border-[#F37021]/30">
                    <Compass className="w-5 h-5 text-[#F37021]" />
                  </div>
                  <div>
                    <span className="font-amatic text-base text-[#F37021] font-bold tracking-wider uppercase block">
                      SOCIAL ECOSYSTEM
                    ...
                    <div className="flex flex-col gap-1.5 mt-1">
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="font-hand text-xl text-espresso hover:underline flex items-center gap-2 font-semibold"
                      >
                      ...
                      <a 
                        ...
                        className="font-hand text-xl text-espresso hover:underline flex items-center gap-2 font-semibold"
                      >
                        <Facebook className="w-4 h-4 text-[#F37021]" />
              ...
              {!submitted ? (
                ...
                >
                  ...
                  <p className="font-hand text-xl text-[#1A1D1C] max-w-md mx-auto leading-relaxed mb-6">
                    Thank you for sharing your resonance. Srini and our founding education coordinators will review your reflections thoughtfully and reach out to you within 3 business days at your address.
                  </p>
